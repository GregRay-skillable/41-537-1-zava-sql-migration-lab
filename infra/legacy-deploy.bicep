...
@description('Whether to deploy the Azure SQL Managed Instance. Set to false to skip when quotas are insufficient.')
        ...
        subnets: [
            ...
            }
            {
                ...
                properties: {
                    ...
                    networkSecurityGroup: (deploySqlMi ? {
                        id: sqlMi_subnet_nsg.id
                    } : null)
                    routeTable: (deploySqlMi ? {
...
resource hub_onprem_vnet_peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2025-01-01' = {
    parent: hub_vnet
    dependsOn: [onprem_subnet, hub_vnet]
    name: 'hub-onprem'
    properties: {
...
resource onprem_hub_vnet_peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2025-01-01' = {
    parent: onprem_vnet
    dependsOn: [hub_vnet, onprem_subnet]
    name: 'onprem-hub'
    properties: {
        remoteVirtualNetwork: {
            id: hub_vnet.id
...
resource spoke_onprem_vnet_peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2025-01-01' = {
  parent: spoke_vnet
    dependsOn: [onprem_subnet, spoke_vnet]
  name: 'spoke-onprem'
  properties: {
    remoteVirtualNetwork: {
      id: onprem_vnet.id
...
resource onprem_spoke_vnet_peering 'Microsoft.Network/virtualNetworks/virtualNetworkPeerings@2025-01-01' = {
  parent: onprem_vnet
    dependsOn: [spoke_vnet, onprem_subnet]
  name: 'onprem-spoke'
  properties: {
    remoteVirtualNetwork: {
      id: spoke_vnet.id
...
resource sqlMi_storage 'Microsoft.Storage/storageAccounts@2025-06-01' = if (deploySqlMi) {
...
resource sqlMi_storage_container 'Microsoft.Storage/storageAccounts/blobServices/containers@2025-06-01' = if (deploySqlMi) {
...
resource sqlMi 'Microsoft.Sql/managedInstances@2024-11-01-preview' = if (deploySqlMi) {
      name: sqlMiPrefix
      location: location
      sku: {
          name: sqlMiSku
...
resource sqlMi_subnet_nsg 'Microsoft.Network/networkSecurityGroups@2025-01-01' = if (deploySqlMi) {
